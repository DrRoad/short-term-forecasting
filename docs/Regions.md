...
Table: Bidding zones and their territories for Norway and Sweden, approximated based on Nord Pool market data [@Seem], [@List], NUTS 3 data and county maps of Norway [@Count19] and Sweden [@Count19a].
...
Table: TSOs and cross-border interconnections in the North Sea region. Data: European Network of Transmission System Operators for Electricity [@ENTSO], [@Regio].
